...
公開 Latest 為 Windows-first Stable App `0.1.27`／Agent Protocol `40`，目前提供 Windows x64 App 與 fabDev Connect；同版 macOS ARM64 尚未補齊，macOS ARM64 可使用前版 `v0.1.26`。Annotated Tag `v0.1.27` 固定在 Commit `3faf3607e68eede8ceef6e811680d0fb4fb1f349`，Release ID `395300351`；Windows 候選 Run `35950396947`、Repository Owner 實機 Gate 與 Draft Run `35951595656` 均已通過。7 個 App-only Assets 共 50,304,839 bytes，Draft 與發布後的匿名公開下載、GitHub digest、大小、逐位元比對、總表、個別 checksum 與 App／Stable Manifest 驗證均通過。Windows Setup SHA-256 為 `ea809cd521e614282d02c7d407570f71029ee9c0ca6436e3d3f8f47a3e3c975e`，Connect 為 `32b97ddd35b800ec27f120601bd9b436b42ef034b47cb137d7defec0afd3459c`；Latest Manifest 目前只列 Windows x64 Installer。此版未打包 macOS DMG，也未處理線上 Runtime Package／Catalog。
