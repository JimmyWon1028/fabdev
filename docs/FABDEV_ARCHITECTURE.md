...
> 狀態：fabDev Desktop Community `v0.1.26` 是目前已發布的 Windows-first App-only Stable，已提供 Windows x64 App、fabDev Connect 與同版 macOS ARM64 Community DMG；本機 `0.1.27` 正準備 Windows x64 候選，後續項目屬維護、功能擴充與產品化驗收
> 更新日期：2026-09-24
