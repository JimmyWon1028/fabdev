...
> 更新日期：2026-09-02
> 目前階段：[`v0.1.19`](https://github.com/JimmyWon1028/fabdev/releases/tag/v0.1.19) 仍是 Latest Stable。Windows-only `v0.1.20` annotated Tag 已固定在 Commit `441972ea02d5d78d675e952b0dee1d2d14bb1a97`，Draft Release ID `381210149` 已建立並完成 20 個 Assets 的重新下載與完整性驗證；macOS Job 與 Assets 均已略過。`v0.1.20` 仍為 `draft=true`、`published_at=null`，未取得 Repository Owner 明確核准前不得 Publish
