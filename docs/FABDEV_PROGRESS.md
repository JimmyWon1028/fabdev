...
> 更新日期：2026-09-01
> 目前階段：`v0.1.17` 雙平台 Draft Release 的 CI、完整資產下載與靜態驗證均已通過；Tag 固定在 Commit `533877cc4b3f05d5d8df94aa99758fefaf16735c`，GitHub Release 維持 Draft、非 Pre-release 且尚未 Publish。Windows Repository Owner 實機 Gate 已通過；macOS 安裝／更新流程未變，依既定規則不重跑耗時人工生命週期測試
