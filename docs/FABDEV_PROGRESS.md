...
> 更新日期：2026-09-01
> 目前階段：第一份 `0.1.17` Windows 候選已作廢；同版本替代候選的 Windows x64 CI 與 NSIS 靜態驗證已通過，等待 Repository Owner 執行 Gate 4 MariaDB 實機重測。macOS 暫不處理，未建立 Tag 或 Release、未發布
